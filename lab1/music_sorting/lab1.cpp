...
void MusicLibrary::get_options(int argc, char** argv) {
    ...
    /*
        ...
        TODO: Add the remaining elements into the longOpts array. check
    ...
    */
while ((option = getopt_long(argc, argv, "p:nalh", 
...
void MusicLibrary::run() {
    ...
    /*
        ...
        TODO: Add the remaining sorting cases (sorting by artist and listens). check
